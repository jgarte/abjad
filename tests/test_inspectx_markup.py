...
def test_inspectx_markup_01():
    ...
    found_markup = abjad.inspectx.markup(chord, direction=abjad.Down)
    assert found_markup == [down_markup]


def test_inspectx_markup_02():
    ...
    down_markup = abjad.Markup("DOWN", direction=abjad.Down)
    abjad.attach(down_markup, chord)
    found_markup = abjad.inspectx.markup(chord, direction=abjad.Up)
