...
def test_Parentage_logical_voice_01():
    ...
    containment = abjad.inspectx.parentage(staff).logical_voice()
    for component in abjad.iterate(staff).components():
        assert abjad.inspectx.parentage(component).logical_voice() == containment
...
def test_Parentage_logical_voice_03():
    ...
    containment = abjad.inspectx.parentage(staff[0][0]).logical_voice()
    for leaf in abjad.iterate(staff).leaves():
        assert abjad.inspectx.parentage(leaf).logical_voice() == containment
...
def test_Parentage_logical_voice_04():
    ...
    signatures = [
        abjad.inspectx.parentage(leaf).logical_voice()
...
def test_Parentage_logical_voice_06():
    ...
    signatures = [abjad.inspectx.parentage(leaf).logical_voice() for leaf in leaves]
...
def test_Parentage_logical_voice_08():
    ...
    signature_1 = abjad.inspectx.parentage(note_1).logical_voice()
    signature_2 = abjad.inspectx.parentage(note_2).logical_voice()
...
def test_Parentage_logical_voice_09():
    ...
    staff_1_leaf_signature = abjad.inspectx.parentage(staff_1[0][0]).logical_voice()
    staff_2_leaf_signature = abjad.inspectx.parentage(staff_2[0][0]).logical_voice()
...
def test_Parentage_logical_voice_10():
    ...
    assert (
        abjad.inspectx.parentage(staff[0]).logical_voice()
        == abjad.inspectx.parentage(staff[-1]).logical_voice()
    )
    assert (
        abjad.inspectx.parentage(staff[0]).logical_voice()
        == abjad.inspectx.parentage(staff[0][0]).logical_voice()
    )
    assert (
        abjad.inspectx.parentage(staff[0][0]).logical_voice()
        == abjad.inspectx.parentage(staff[-1]).logical_voice()
...
def test_Parentage_logical_voice_11():
    ...
    leaves = abjad.select(container).leaves()
    assert (
        abjad.inspectx.parentage(leaves[0]).logical_voice()
        == abjad.inspectx.parentage(leaves[1]).logical_voice()
    )
    assert (
        abjad.inspectx.parentage(leaves[0]).logical_voice()
        != abjad.inspectx.parentage(leaves[2]).logical_voice()
    )
    assert (
        abjad.inspectx.parentage(leaves[2]).logical_voice()
        == abjad.inspectx.parentage(leaves[3]).logical_voice()
    )
    assert (
        abjad.inspectx.parentage(leaves[2]).logical_voice()
        != abjad.inspectx.parentage(leaves[0]).logical_voice()
