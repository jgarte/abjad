...
def test_IOManager_compare_files_01():
    """
    ...
    with abjad.FilesystemState(remove=[path_1, path_2]):
        ...
        with open(path_2, "w") as file_pointer:
            file_pointer.write("\n".join(second_lines))
        assert abjad.IOManager._compare_lys(path_1, path_2)


def test_IOManager_compare_files_02():
    """
...
def test_IOManager_compare_files_03():
    """
...
def test_IOManager_compare_files_04():
    """
    ...
    with abjad.FilesystemState(remove=[path_1, path_2]):
        ...
        with open(path_2, "w") as file_pointer:
            file_pointer.write("\n".join(second_lines))
        assert not abjad.IOManager._compare_lys(path_1, path_2)
...
def test_IOManager_compare_files_05():
    """
    Is true when lines are exactly the same.
    """
    ...
    with abjad.FilesystemState(remove=[path_1, path_2]):
        ...
        with open(path_2, "w") as file_pointer:
            file_pointer.write("\n".join(second_lines))
        assert abjad.IOManager._compare_text_files(path_1, path_2)


def test_IOManager_compare_files_06():
    """
...
def test_IOManager_compare_files_07():
    """
    False when any other lines differ.
    """
    ...
    with abjad.FilesystemState(remove=[path_1, path_2]):
        ...
        with open(path_2, "w") as file_pointer:
            file_pointer.write("\n".join(second_lines))
        assert not abjad.IOManager._compare_text_files(path_1, path_2)
