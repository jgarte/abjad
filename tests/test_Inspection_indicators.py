...
def test_Inspection_indicators_01():
    ...
    indicators = abjad.inspectx.indicators(staff[0], abjad.LilyPondLiteral)
...
def test_Inspection_indicators_02():
    ...
    items = abjad.inspectx.indicators(staff[0])
...
def test_Inspection_indicators_03():
    ...
    indicators = abjad.inspectx.indicators(staff[0])
    assert len(indicators) == 2
...
def test_Inspection_indicators_04():
    ...
    indicators = abjad.inspectx.indicators(staff[0], abjad.LilyPondComment)
...
def test_Inspection_indicators_05():
    ...
    stem_tremolos = abjad.inspectx.indicators(note, abjad.StemTremolo)
