...
class Parentage(collections.abc.Sequence):
    ...
    ..  container:: example
        ...
        >>> note = bass_voice[0]
        >>> for component in abjad.inspectx.parentage(note):
        ...     component
        ...
        Note('c4')
    ...
    def count(self, prototype=None) -> int:
        ...
        ..  container:: example
            ...
            ...     depth = abjad.inspectx.parentage(leaf).count(abjad.Voice)
            ...     print(leaf, depth)
            ...
            e''8 1
            d''8 1
    ...
    def get(self, prototype=None, n=0) -> typing.Optional[Component]:
        ...
        ..  container:: example
            ...
            ..  container:: example
                ...
                >>> leaf = abjad.inspectx.leaf(inner_red_voice, 0)
                >>> leaf
                Note("c''4")
    ...
    def logical_voice(self) -> OrderedDict:
        ...
        ..  container:: example
            ...
            >>> note = voice[0]
            >>> parentage = abjad.inspectx.parentage(note)
        ...
        ..  container:: example
            ...
            >>> lv = abjad.inspectx.parentage(voice).logical_voice()
            >>> abjad.f(lv)
            abjad.OrderedDict(
                [
                    ('score', ''),
            ...
            >>> lv = abjad.inspectx.parentage(container_1).logical_voice()
            >>> abjad.f(lv)
            abjad.OrderedDict(
                [
                    ('score', ''),
            ...
            >>> lv = abjad.inspectx.parentage(container_1[0]).logical_voice()
            >>> abjad.f(lv)
            abjad.OrderedDict(
                [
                    ('score', ''),
            ...
            >>> lv = abjad.inspectx.parentage(container_2).logical_voice()
            >>> abjad.f(lv)
            abjad.OrderedDict(
                [
                    ('score', ''),
            ...
            >>> lv = abjad.inspectx.parentage(container_2[0]).logical_voice()
            >>> abjad.f(lv)
            abjad.OrderedDict(
                [
                    ('score', ''),
