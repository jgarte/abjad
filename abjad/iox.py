...
from .formatx import StorageFormatManager
...
class IOManager:
    ...
    def _compare_backup(path):
        ...
        for path in paths:
            ...
            if not IOManager.compare_files(path, backup_path):
                return False
        return True
    ...
    def _compare_lys(path_1, path_2):
        ...
        """
        file_1_lines = IOManager._normalize_ly(path_1)
        file_2_lines = IOManager._normalize_ly(path_2)
    ...
    def compare_files(path_1, path_2):
        ...
        * Discards any lines beginning with ``%``
        ...
        if extension_1 == ".ly":
            return IOManager._compare_lys(path_1, path_2)
        else:
            return IOManager._compare_text_files(path_1, path_2)
